...
<body>
    ...
    <section class="seccionFaq">
        ...
        <article class="articulos">
            <p>¿Cómo ingreso a la app?</p>
            <div class="textoarticulo">
                <p>Primero debes registrarte para poder ingresar</p>
            </div>
        </article>
        <article class="articulos">
            <p>¿Qué pasa si olvido la contraseña? </p>
            <div class="textoarticulo">
                <p>Puedes solicitar una nueva contraseña</p>
            </div>
        </article>
        <article class="articulos">
            <p>¿Cuántos prestamos puedo subir a la app?</p>
            <div class="textoarticulo">
                <p>Todos los que necesites</p>
            </div>
        </article>
    </section>
