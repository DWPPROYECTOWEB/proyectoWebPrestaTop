...
<body>
    ...
    <section class="seccionPres1">
        ...
        <div class="tituloPrestamos">PS4</div>
        <section id="bloque">
            ...
            <table class="tablaproductos">
              <tr>
                <td>
                    <img class ="mini_imagenes" src="img/ps4_3.jpg" alt="ps4 tercera imagen">
                </td>
                <td>
                    <img class ="mini_imagenes" src="img/ps4_2.jpeg" alt="ps4 segunda imagen">
                </td>
              </tr>
            </table>
        </section>
